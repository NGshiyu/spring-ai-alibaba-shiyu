 ...
 * <p>
 * * 2025-12-17 override by NGshiyu:Adapt to the Qwen Model, change the merge logic when incremental_output is false
 *
    ...
    public ChatCompletionChunk merge(ChatCompletionChunk previous, ChatCompletionChunk current) {
        ...
        if (!incrementalOutput && isStreamingToolFunctionCall(current)) {
            ...
            if (isStreamingToolFunctionCallFinish(current)) {
                ...
                return new ChatCompletionChunk(id, List.of(currentChoice0), created, model, serviceTier, systemFingerprint, object, usage);
            }
        }
