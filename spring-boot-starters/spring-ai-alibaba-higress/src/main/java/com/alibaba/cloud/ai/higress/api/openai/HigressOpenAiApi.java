 ...
 * Embedding API</a>.
 * <p>
 * 2025-12-17 override by NGshiyu: Adapt to the Qwen model. The Qwen model can use it and pass some
...
public class HigressOpenAiApi {
     ...
     */
    public HigressOpenAiApi(String baseUrl, ApiKey apiKey, MultiValueMap<String, String> headers, String completionsPath,
    ...
    public Flux<ChatCompletionChunk> chatCompletionStream(ChatCompletionRequest chatRequest,
        ...
        if (chatRequest.incrementalOutput != null && chatRequest.enableThinking != null && !chatRequest.incrementalOutput) {
    ...
    public record ChatCompletionRequest(// @formatter:off
			...
			@JsonProperty("safety_identifier") String safetyIdentifier,
                                        ...
                                        @JsonProperty("search_options") QwenOpenAiCompatibleSearchOptions qwenSearchOptions,
		...
		public ChatCompletionRequest(List<ChatCompletionMessage> messages, String model,
			...
			this(messages, model, null, null, null, null, null, null, null, null, null,
					...
					tools, toolChoice, null, null, null, null, null, null, null, null, null, null, null, null);
		}
		...
		public ChatCompletionRequest streamOptions(StreamOptions streamOptions) {
			return new ChatCompletionRequest(this.messages, this.model, this.store, this.metadata, this.frequencyPenalty, this.logitBias, this.logprobs,
					...
					this.promptCacheKey, this.safetyIdentifier, this.enableThinking,this.enableSearch,this.qwenSearchOptions,this.incrementalOutput,this.extraBody);
		}
    ...
    public static final class Builder {
        ...
        public HigressOpenAiApi build() {
            ...
            return new HigressOpenAiApi(this.baseUrl, this.apiKey, this.headers, this.completionsPath, this.embeddingsPath,
