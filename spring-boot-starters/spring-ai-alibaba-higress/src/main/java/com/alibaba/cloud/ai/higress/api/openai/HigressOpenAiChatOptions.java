 ...
 * <p>
 * 2025-12-17 override by NGshiyu:  Adapt to the Qwen model
 *
...
public class HigressOpenAiChatOptions implements ToolCallingChatOptions {
    ...
    private static final Logger logger = LoggerFactory.getLogger(HigressOpenAiChatOptions.class);
    ...
    public int hashCode() {
        return Objects.hash(this.model, this.frequencyPenalty, this.logitBias, this.logprobs, this.topLogprobs,
                ...
                this.serviceTier, this.promptCacheKey, this.safetyIdentifier, this.enableThinking, this.enableSearch, this.searchOptions, this.incrementalOutput, this.extraBody);
    }
    ...
    public static final class Builder {
        ...
        public Builder serviceTier(HigressOpenAiApi.ServiceTier serviceTier) {
