...
public class HigressOpenAiChatModel implements ChatModel {
    ...
    public HigressOpenAiChatModel(HigressOpenAiApi higressOpenAiApi, HigressOpenAiChatOptions defaultOptions, ToolCallingManager toolCallingManager,
        ...
        ChatResponse response = ChatModelObservationDocumentation.CHAT_MODEL_OPERATION
                ...
                .observe(() -> {
                    ...
                    ResponseEntity<ChatCompletion> completionEntity = this.retryTemplate
                            .execute(ctx -> this.higressOpenAiApi.chatCompletionEntity(request, getAdditionalHttpHeaders(prompt)));
    ...
    public Flux<ChatResponse> internalStream(Prompt prompt, ChatResponse previousChatResponse) {
        return Flux.deferContextual(contextView -> {
            ...
            Flux<HigressOpenAiApi.ChatCompletionChunk> completionChunks = this.higressOpenAiApi.chatCompletionStream(request,
    ...
    private String getFinishReasonJson(HigressOpenAiApi.ChatCompletionFinishReason finishReason) {
    ...
    private List<HigressOpenAiApi.FunctionTool> getFunctionTools(List<ToolDefinition> toolDefinitions) {
        return toolDefinitions.stream().map(toolDefinition -> {
            var function = new HigressOpenAiApi.FunctionTool.Function(toolDefinition.description(), toolDefinition.name(),
