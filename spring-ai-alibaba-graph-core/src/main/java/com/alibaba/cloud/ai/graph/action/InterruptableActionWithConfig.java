...
/**
 * Defines a contract for actions that can interrupt the execution of a graph with configuration.
 *
 */
public interface InterruptableActionWithConfig extends ActionLifecycle<Exception> {
